...
public class HL7TokeniserTests
{
    ...
    public void GeneratedReader_ReadStringField_PresentButNull()
    {
        ...
        Assert.Null(oru.PatientResult.Single().Patient.Pid.PrimaryLanguage);
    }
    ...
    public void GeneratedReader_ReadStringArrayField()
    {
        ...
        string?[] expected = [
            ...
            "HL0189",
            null, // We should read and return PresentButNull, without terminating the array
            "END"
            ];
